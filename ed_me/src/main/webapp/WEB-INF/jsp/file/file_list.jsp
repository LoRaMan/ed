    ...
    <table id="tt" class="easyui-datagrid" style="width:100%;height:480px" data-options="rownumbers:true,pagination:true">
        <thead>
            <tr>
                ...
                <th data-options="field:'category.categoryName',width:70">归属分类</th>
                <th data-options="field:'project.projectName',width:70">归属项目</th>
                <th data-options="field:'fileType',width:70,align:'right'">文件类型</th>
                <th data-options="field:'fileSize',width:100,align:'right'">文件大小</th>
                <th data-options="field:'uploadTime',width:100">上传时间</th>
                <th data-options="field:'uploader',width:100,align:'center'">上传人</th>
                <th data-options="field:'secretLevel',width:70,align:'center'">保密级别</th>
