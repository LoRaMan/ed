		    ...
		    <s:form action="fileAction_edit" class="form-horizontal" role="form">
		        ...
		        <div class="form-group">
		            <div class="row">
		                ...
		                <div class="col-sm-8">
		                    <input type="text" class="form-control" required="required" name="fileType" value="${fileType }">
		                </div>
		            </div>
		        </div>
		        <div class="form-group">
		            <div class="row">
		                ...
		                <div class="col-sm-8">
		                    <input type="text" class="form-control" required="required" name="secretLevel" value="${secretLevel }">
		                </div>
		            </div>
		        </div>
		        <div class="form-group">
		        ...
		        <div class="form-group">
		            <div class="row">
		                ...
		                <div class="col-sm-8">
		                    <input type="text" class="form-control" required="required" name="fileStatus" value="${fileStatus }">
		                </div>
		            </div>
		        </div>
